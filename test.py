...
while True:
	...
	for x,y,w,h in faces:
		...
		print(prediction[0][0],prediction[0][1],type(prediction[0][0]))
		...
		if probabilityValue>threshold:
			if prediction[0][1] > 0.7:
				...
				cv2.putText(imgOrignal, str(get_className(0)),(x,y-10), font, 0.75, (255,255,255),1, cv2.LINE_AA)
			elif prediction[0][0] > 0.7:
				cv2.rectangle(imgOrignal,(x,y),(x+w,y+h),(50,50,255),2)
				cv2.rectangle(imgOrignal, (x,y-40),(x+w, y), (50,50,255),-2)
				cv2.putText(imgOrignal, str(get_className(1)),(x,y-10), font, 0.75, (255,255,255),1, cv2.LINE_AA)
